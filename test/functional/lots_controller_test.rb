...
class LotsControllerTest < ActionController::TestCase
  ...
  test "should create lot" do
    assert_difference('Lot.count') do
      post :create, lot: { address: @lot.address, capacity: @lot.capacity, name: @lot.name, price: @lot.price }
    end
  ...
  test "should update lot" do
    put :update, id: @lot, lot: { address: @lot.address, capacity: @lot.capacity, name: @lot.name, price: @lot.price }
    assert_redirected_to lot_path(assigns(:lot))
  end
